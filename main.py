...
with st.sidebar:
    ...
    st.header('About Me')
    st.markdown("[Linkedin](https://www.linkedin.com/in/shatesh-soni-15976519b)")
...
<div class="footer">
<p>Developed with ❤ by <a style='display: block; text-align: center;' href="https://www.linkedin.com/in/shatesh-soni-15976519b" target="_blank">Shatesh Soni</a></p>
</div>
"""
